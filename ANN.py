...
n_nodes_hl2=500
n_nodes_hl3=500
train_x=[[2,3,4],[5,6,7]] # training data.
train_y=[[1,0],[0,1]]     # one- hot encoding.
...
def train_neural_network(x):
  prediction=neural_network_node(x)
  ...
  with tf.Session() as sess:
    ...
    #print('Accuracy: ',accuracy.eval({x:text_x,y:text_y}))  # update test_x, and test_y     for testing the neural network.
